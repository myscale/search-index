...
class VarLenFeatureProto final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_values_output_tensor_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_indices_output_tensor_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_shapes_output_tensor_name();
...
class FixedLenFeatureProto final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::TensorProto* release_default_value();
...
class FeatureConfiguration final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::FixedLenFeatureProto* release_fixed_len_feature();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::VarLenFeatureProto* release_var_len_feature();
