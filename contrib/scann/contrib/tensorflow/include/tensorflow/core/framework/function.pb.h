...
class FunctionDef_ArgAttrs final :
 ...
 public:
  ...
  inline FunctionDef_ArgAttrs* New() const final {
    return new FunctionDef_ArgAttrs();
  }
...
class FunctionDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::OpDef* release_signature();
...
class GradientDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_gradient_func();
...
class RegisteredGradient final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_registered_op_type();
