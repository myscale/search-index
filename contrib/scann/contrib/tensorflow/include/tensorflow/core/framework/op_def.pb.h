...
class OpDef_ArgDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_type_attr();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_number_attr();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_type_list_attr();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::FullTypeDef* release_experimental_full_type();
...
class OpDef_AttrDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::AttrValue* release_allowed_values();
...
class OpDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::OpDeprecation* release_deprecation();
...
class OpDeprecation final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_explanation();
