...
class AttrValue final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::AttrValue_ListValue* release_list();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::NameAttrList* release_func();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_placeholder();
