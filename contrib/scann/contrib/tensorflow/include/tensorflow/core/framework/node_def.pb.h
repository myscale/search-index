...
class NodeDef_ExperimentalDebugInfo final :
 ...
 public:
  ...
  inline NodeDef_ExperimentalDebugInfo* New() const final {
    return new NodeDef_ExperimentalDebugInfo();
  }
...
class NodeDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::NodeDef_ExperimentalDebugInfo* release_experimental_debug_info();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::FullTypeDef* release_experimental_type();
