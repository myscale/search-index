...
class NodeOutput final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::TensorDescription* release_tensor_description();
...
class NodeExecStats final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_timeline_label();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::MemoryStats* release_memory_stats();
