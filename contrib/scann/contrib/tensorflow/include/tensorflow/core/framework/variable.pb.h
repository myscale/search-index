...
class VariableDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_initializer_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_snapshot_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_initial_value_name();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::SaveSliceInfoDef* release_save_slice_info_def();
