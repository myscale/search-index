...
class RewriterConfig_CustomGraphOptimizer final :
 ...
 public:
  ...
  inline RewriterConfig_CustomGraphOptimizer* New() const final {
    return new RewriterConfig_CustomGraphOptimizer();
  }
...
class RewriterConfig final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_memory_optimizer_target_node_name_scope();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::AutoParallelOptions* release_auto_parallel();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::ScopedAllocatorOptions* release_scoped_allocator_opts();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::VerifierConfig* release_inter_optimizer_verifier_config();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::VerifierConfig* release_post_optimization_verifier_config();
