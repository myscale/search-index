...
class ControlFlowContextDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::CondContextDef* release_cond_ctxt();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::WhileContextDef* release_while_ctxt();
...
class CondContextDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_context_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_pred_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_pivot_name();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::ValuesDef* release_values_def();
...
class WhileContextDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_pivot_for_pred_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_pivot_for_body_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_maximum_iterations_name();
