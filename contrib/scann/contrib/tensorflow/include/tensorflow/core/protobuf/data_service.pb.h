...
class DataServiceMetadata final :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_cardinality() const;
  void _internal_set_cardinality(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_element_spec();
...
class CrossTrainerCacheOptions final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_trainer_id();
...
inline ::PROTOBUF_NAMESPACE_ID::int64 DataServiceMetadata::_internal_cardinality() const {
  return cardinality_;
}
...
inline void DataServiceMetadata::_internal_set_cardinality(::PROTOBUF_NAMESPACE_ID::int64 value) {
