...
class SaverDef final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_filename_tensor_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_save_tensor_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_restore_op_name();
