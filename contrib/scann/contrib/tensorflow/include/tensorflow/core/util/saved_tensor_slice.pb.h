...
class SavedSlice final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::TensorSliceProto* release_slice();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::TensorProto* release_data();
...
class SavedTensorSlices final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::SavedTensorSliceMeta* release_meta();
  ...
  PROTOBUF_MUST_USE_RESULT ::tensorflow::SavedSlice* release_data();
