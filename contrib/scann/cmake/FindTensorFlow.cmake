...
execute_process(
    COMMAND
    ${PYTHON_CMD} -c "import tensorflow as tf; print(tf.sysconfig.get_include())"
...
execute_process(
    COMMAND
    ${PYTHON_CMD} -c "import tensorflow as tf; print(tf.sysconfig.get_lib())"
    RESULT_VARIABLE result
...
execute_process(
    COMMAND
    ${PYTHON_CMD} -c "import tensorflow as tf; print(tf.__cxx11_abi_flag__)"
    RESULT_VARIABLE result
...
execute_process(
    COMMAND
    ${PYTHON_CMD} -c "import tensorflow as tf; print(tf.__git_version__)"
    RESULT_VARIABLE result
...
execute_process(
    COMMAND
    ${PYTHON_CMD} -c "import tensorflow as tf; print(tf.__version__)"
    RESULT_VARIABLE result
